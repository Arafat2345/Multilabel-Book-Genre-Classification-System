...
if __name__ == "__main__":
    ...
    base_url = "https://www.goodreads.com/list/show/4093.Best_Books_of_the_Decade_2010s"
    book_urls = []
    
    for idx in tqdm(range(77)):
    ...
    df.to_csv("best_books_2010's _urls.csv", index=False)
